...
import dev.elijuh.minerpvp.util.ReflectionUtil;
...
public class FastBoard {
    ...
    private boolean deleted, displayingHealth;
    ...
    public FastBoard(Player player) {
        ...
        try {
            ...
            sendDisplayObjectivePacket(this.id);
        } catch (Throwable t) {
    ...
    private void sendObjectivePacket(ObjectiveMode mode) throws Throwable {
        ...
        if (mode != ObjectiveMode.REMOVE) {
            ...
            if (VersionType.V1_8.isHigherOrEqual()) {
                setField(packet, ENUM_SB_HEALTH_DISPLAY, FastBoard.ENUM_SB_HEALTH_DISPLAY_INTEGER);
            }
    ...
    private void sendDisplayObjectivePacket(String id) throws Throwable {
